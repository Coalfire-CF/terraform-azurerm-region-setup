...
output "linux_domainjoin_url" {
  value = length(azurerm_storage_blob.linux_domainjoin.url) > 0 ? azurerm_storage_blob.linux_domainjoin.url : null
}
output "linux_monitor_agent_url" {
  value = length(azurerm_storage_blob.linux_monitor_agent.url) > 0 ? azurerm_storage_blob.linux_monitor_agent.url : null
}
